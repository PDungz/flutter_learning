...
import 'package:flutter_basic/Remote_API/assignment/features/home/domain/usecase/movie_usecase.dart';
...
class MovieInfoBloc extends Bloc<MoviesEvent, MoviesState> {
  ...
  Future<void> _onLoadMovies(
    ...
    emit(MoviesLoading());
    try {
      final movies = await getMovies.getNowPlayingMoviews();
      final upcommingMovies = await getMovies.getUpcommingMovice();
      emit(MoviesLoaded(
        movies ?? [],
        upcommingMovies ?? [],
      ));
